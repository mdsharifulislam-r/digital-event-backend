...
router.route('/')
    ...
    .get(auth(USER_ROLES.ADMIN, USER_ROLES.ORGANIZATION),VanueController.getMyAllVanue);

router.route('/:id')
    .get(auth(USER_ROLES.ADMIN, USER_ROLES.ORGANIZATION),VanueController.getVanueById)
    ...
    .delete(auth(USER_ROLES.ADMIN, USER_ROLES.ORGANIZATION),VanueController.deleteVanue);
